...
// Return the object
const createObjectWithKeyValue = (str) => {
  return { key: str }
}
...
const keys2 = ['w', 'x', 'y', 'z'];
const values2 = [10, 9, 5, 2];
console.log(createObjectFromArrays(keys2, values2));

const keys3 = ['1', 'b'];
const values3 = ['a', 2];
console.log(createObjectFromArrays(keys3, values3));
/*
Test cases:
